...
async function readState(client, initialState) {
...
export function createPostgresStore(
  ...
  async function snapshot() {
    ...
    try {
      ...
      const state = await readState(client, initialState);
  ...
  return {
    ...
    async transaction(fn) {
      ...
      try {
        ...
        const state = await readState(client, initialState), result = await fn(state);
